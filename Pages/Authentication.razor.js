...
(function (JSInteropWithTypeScript) {
    ...
    JSInteropWithTypeScript.showPrompt = showPrompt;
    function fetchTokenAsync(origin, code, clientId, codeVerifier, redirectUri, authorization, isDebug) {
    ...
    JSInteropWithTypeScript.fetchTokenAsync = fetchTokenAsync;
})(JSInteropWithTypeScript || (JSInteropWithTypeScript = {}));
//# sourceMappingURL=Authentication.razor.js.map